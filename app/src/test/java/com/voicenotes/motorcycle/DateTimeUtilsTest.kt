...
class DateTimeUtilsTest {
    ...
    fun testTimezoneHandling() {
        ...
        val formattedPst = DateTimeUtils.formatTimestamp(timestamp, "yyyy-MM-dd HH:mm:ss", "America/Los_Angeles")
        assertEquals("PST formatting (UTC-8)", "2024-01-26 04:00:00", formattedPst)
        
        val formattedCet = DateTimeUtils.formatTimestamp(timestamp, "yyyy-MM-dd HH:mm:ss", "Europe/Paris")
        ...
        val formattedDefault = DateTimeUtils.formatTimestamp(timestamp, "yyyy-MM-dd HH:mm:ss")
    ...
    fun testDateFormatPatterns() {
        ...
        assertEquals("12-hour format", "12:00:00 PM", 
            DateTimeUtils.formatTimestamp(timestamp, "hh:mm:ss a", "UTC", Locale.US))
    }
